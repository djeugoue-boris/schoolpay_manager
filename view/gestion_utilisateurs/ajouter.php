...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM utilisateurs WHERE identifiant = ?");
    ...
    if ($stmt->fetchColumn() > 0) {
        ...
        $stmt = $pdo->prepare("INSERT INTO utilisateurs (identifiant, mot_de_passe, role, statut) VALUES (?, ?, ?, ?)");
        $stmt->execute([$identifiant, $mot_de_passe_hash, $role, $statut]);
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                <label for="mot_de_passe" class="form-label text-dark">Mot de passe</label>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-plus-circle"></i> Ajouter l'utilisateur
                                </button>
