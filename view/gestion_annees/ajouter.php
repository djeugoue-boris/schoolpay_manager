...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM annees_scolaires WHERE libelle = ?");
    ...
    if ($stmt->fetchColumn() > 0) {
        ...
        $stmt = $pdo->prepare("INSERT INTO annees_scolaires (libelle, active) VALUES (?, ?)");
        $stmt->execute([$libelle, $active]);
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-dark fw-bold text-center">Ajouter une année scolaire</h3>
                    </div>
                    <div class="card-body">
